<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nouveau concept</h2>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('concepts.store', $domain->id) }}">
                    @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="explanation" name="explanation" rows="6" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>{{ old('explanation') }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="status" id="status" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div class="flex items-center justify-end mt-6">
                        <a href="{{ route('concepts.index', $domain->id) }}" class="text-gray-600 hover:text-gray-900 mr-4">Annuler</a>
                        <x-primary-button>Creer</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
