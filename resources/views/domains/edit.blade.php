            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('domains.update', $domain) }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $domain->name)" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center gap-3 mt-1">
                            <input type="color" id="color_picker" value="{{ old('color', $domain->color) }}" class="w-12 h-10 border border-gray-300 rounded cursor-pointer">
                            <x-text-input id="color_hex" class="block flex-1" type="text" name="color" :value="old('color', $domain->color)" placeholder="#3B82F6" />
                        </div>
